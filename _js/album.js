...
function createTrack(i, intAlbum) {
  ...
  JSONsingle.push({'name':strTrackName,'album':intAlbum, 'releasedDate':false, 'qualityRating':intQualityRating, 'recordedDate':GLOBALdatDateCurrent.getTime(), 'chartPosition':0, 'chartPositionBest':99999, 'chartHistory':''});
